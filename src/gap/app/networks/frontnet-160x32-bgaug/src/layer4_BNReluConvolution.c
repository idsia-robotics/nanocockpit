...
// func_name                      layer4_BNReluConvolution
// flag_DW                        0
// optional                       BNReluConv
// FLAG_BATCHNORM                 1
// has_bias                       0
...
// k_tile_size_byte_transfer      512
// lambda_tile_size_byte_transfer 512
// bias_tile_size_byte            0
// l1_x_offset                    0
// l1_y_offset                    7688
// l1_W_offset                    11536
// l1_k_offset                    29976
// l1_lambda_offset               30496
...
void layer4_BNReluConvolution(
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      x_tile_size_h   = (_i_h_load+1 == 1)   ? 12 : 12;
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 12, 20, 32, 20, 32,  1, 1,0, pad_offset_h, pad_offset_w, 0, 8);
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_W.loc = (l1_buffer + 11536);
        ...
        DMA_copy_k.ext = (uint32_t) l2_W+18432 + 512*_i_nof_load;
        DMA_copy_k.loc = (uint32_t) l1_buffer + 29976;
        DMA_copy_k.length_1d_copy = (uint16_t) W_tile_size_nof * 8;
        dory_dma_memcpy_async(&DMA_copy_k);
        dory_dma_barrier(&DMA_copy_k);

        DMA_copy_lambda.ext = (uint32_t) l2_W+18944 + 512*_i_nof_load;
        DMA_copy_lambda.loc = (uint32_t) l1_buffer + 30496;
    ...
    k = (int64_t *) (l1_buffer + 29976);
    lambda = (int64_t *) (l1_buffer + 30496);
    W = (uint8_t *) (l1_buffer + 11536);
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 6, 10, 64, 10, 64, 0, 0, 0, 0, 0, 0, 8);
