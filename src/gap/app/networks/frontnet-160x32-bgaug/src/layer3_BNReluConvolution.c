...
// func_name                      layer3_BNReluConvolution
// flag_DW                        0
// optional                       BNReluConv
// FLAG_BATCHNORM                 1
// has_bias                       0
...
void layer3_BNReluConvolution(
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 12, 20, 32, 20, 32,  2, 2,0, pad_offset_h, pad_offset_w, 0, 8);
    ...
    k = (int64_t *) (l1_buffer + 24600);
    lambda = (int64_t *) (l1_buffer + 24864);
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 12, 20, 32, 20, 32, 0, 0, 0, 0, 0, 0, 8);
