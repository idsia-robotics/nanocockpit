...
/**
 * @brief Register a new LED sequence with the highest priority. Sequences must be
 *        registerd before they can be used, sequences added with this function override
 *        any previous sequence on the same LED.
 *
 * @param context Pointer to a LED seqence runtime context. Note the
 *        context will be part of linked list of contexts and must exist
 *        as long as the system is running.
